<?php /* Smarty version Smarty-3.1.19, created on 2023-02-06 11:55:07
         compiled from "/var/www/luminadecoshop.ru/data/www/luminadecoshop.ru/admin843ifpurg/themes/default/template/controllers/information/helpers/view/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:144621732063e0c06b8d2390-96452575%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '05580acd0b3b0e7e2f7cd6e2c80d335047579b83' => 
    array (
      0 => '/var/www/luminadecoshop.ru/data/www/luminadecoshop.ru/admin843ifpurg/themes/default/template/controllers/information/helpers/view/view.tpl',
      1 => 1675113752,
      2 => 'file',
    ),
    'c077b4f5d4759a743144e6f570603fb2a343d709' => 
    array (
      0 => '/var/www/luminadecoshop.ru/data/www/luminadecoshop.ru/admin843ifpurg/themes/default/template/helpers/view/view.tpl',
      1 => 1675113723,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '144621732063e0c06b8d2390-96452575',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_63e0c06b90d887_67063622',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_63e0c06b90d887_67063622')) {function content_63e0c06b90d887_67063622($_smarty_tpl) {?>
...
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['uname']->value,'html','UTF-8');?>

				</p>
				<?php }?>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Server software version:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['version']->value['server'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'PHP version:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['version']->value['php'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Memory limit:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['version']->value['memory_limit'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Max execution time:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['version']->value['max_execution_time'],'html','UTF-8');?>
...
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['version'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'MySQL server:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['server'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'MySQL name:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['name'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'MySQL user:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['user'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Tables prefix:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['prefix'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'MySQL engine:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['engine'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'MySQL driver:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['database']->value['driver'],'html','UTF-8');?>
...
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['shop']->value['ps'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Shop URL:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['shop']->value['url'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'Current theme in use:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['shop']->value['theme'],'html','UTF-8');?>
...
:</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['smtp']->value['server'],'html','UTF-8');?>
...
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['smtp']->value['encryption'],'html','UTF-8');?>

				</p>
				<p>
					<strong><?php echo smartyTranslate(array('s'=>'SMTP port:'),$_smarty_tpl);?>
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['smtp']->value['port'],'html','UTF-8');?>
...
</strong> <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['escape'][0][0]->escapePTS($_smarty_tpl->tpl_vars['user_agent']->value,'html','UTF-8');?>
