                        ...
                        <div id="views_block" class="clearfix {if isset($images) && count($images) < 2}hidden{/if}">
                            ...
                            <div id="thumbs_list">
                                ...
                                <ul id="thumbs_list_frame">
									...
									<a class="round-arrow-button left swiper-button-left s3x bordered vertical"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><path d="M15 3l-9 9 9 9"></path></svg></a>
									<a class="round-arrow-button swiper-button-right s3x bordered vertical"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" tabindex="-1"><path d="M9 3l9 9-9 9"></path></svg></a>
                                </ul>
                        ...
                        {if $have_image}
                            <span id="view_full_size">
                                {if $jqZoomEnabled && $have_image && !$content_only}
                                    ...
                                    getImageLink($product->link_rewrite, $cover.id_image, 'large_default')|escape:'html':'UTF-8'}" itemprop="url">
				...
				<form id="buy_block"{if $PS_CATALOG_MODE && !isset($groups) && $product->quantity > 0} class="hidden"{/if}  action="{$link->getPageLink('cart')|escape:'html':'UTF-8'}" method="post">
					...
					<div class="box-info-product">
                                            ...
                                            {foreach from=$accessories item=accessory name=accessories_list}
												...
												<li class="producten">
													<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" class="lnk_img product-image">
														<img src="{$link->
                                                        getImageLink($accessory.link_rewrite, $accessory.id_image, 'cart_default')}"
															 alt="{$accessory.legend|escape:'html':'UTF-8'}" width="69" height="80"/>
													</a>
						...
						<div class="product_attributes clearfix">
                            ...
                            {if isset($accessories2) AND $accessories2}
								<!-- accessories -->
								<section id="last_viewed" class="page-product-box blockproductscategory">
									<div class="titlebordrtext1">
                                        {l s='Цвета:'}
									...
									<div id="similiar_products" class="clearfix">
										<ul class="collections clearfix">
                                            {foreach from=$accessories2 item=accessory name=accessories_list}
                                                {assign var='accessoryLink' value=$link->getProductLink($accessory.id_product, $accessory.link_rewrite, $accessory.category)}
												<li class="producten">
													<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}" class="lnk_img product-image">
														<img src="{$link->
									...
									<li class="product-box item">
										...
										<h5 class="product-name">
											<a href="{$accessoryLink|escape:'htmlall':'UTF-8'}">
												{$accessory.name|truncate:40:'...':true|escape:'htmlall':'UTF-8'}
											</a>
										</h5>
	...
	<script>
        ...
        setTimeout(function () {
            ...
            if(document.documentElement.clientWidth < 992) {
                $(".round-arrow-button").removeClass('vertical');
            }

            var swiper = new Swiper("#thumbs_list_frame .swiper-container", {
                direction: "vertical",
                slidesPerView: "auto",
                spaceBetween: 10,
                autoHeight: false,
